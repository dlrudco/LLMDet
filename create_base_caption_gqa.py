...
# 경로는 상황에 맞게 바꿔줘
base_path = '/mnt/sdd/grounding_data/gqa'
INPUT_JSONL_PATH  = os.path.join(base_path, "gqa_train_vg7.jsonl")  # 원본 jsonl
OUTPUT_JSONL_PATH = os.path.join(base_path, "gqa_train_base.jsonl")  # 결과 jsonl
